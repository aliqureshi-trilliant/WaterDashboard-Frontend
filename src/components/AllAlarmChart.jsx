import classes from './AllAlarmChart.module.css';
...
function AllAlarmChart(props){
    ...
    const fetchData = () => {
        fetch('http://localhost:3000/api/waterMIUs/KPIs/alarms?days=1')
            .then((response) => {
                if(!response.ok) {
